...
<div class='columns'>
    <div class='skills'>
        <h4>Frontend</h4>
        <div class='skill'><span>✓</span> Pug</div>
    </div>
    <div class='skills'>
        <h4>Backend</h4>
        <div class='skill'><span>✓</span> ExpressJS</div>
        <div class='skill'><span>✓</span> Sequelize</div>
        <div class='skill'><span>✓</span> CORS Middleware</div>
        <div class='skill'><span>✓</span> Express Bearer Token</div>
